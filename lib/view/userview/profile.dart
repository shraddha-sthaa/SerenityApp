                            ...
                            child: ListView(
                              children: [
                                ListTile(
                                    ...
                                    if (dsc.profile!.premiumUser == 0) {
                                      ...
                                      KhaltiScope.of(context).pay(
                                        ...
                                        onSuccess: (PaymentSuccessModel model) {
                                          ...
                                          paymentPageController.savePayment(
                                            PaymentModel(
                                              paymentId: '',
                                              paymentDate: DateTime.now(),
                                              khaltiNum: model.mobile,
                                              profileId: dsc.profile!.profileId
                                                  .toString(),
                                              totalAmount:
                                                  model.amount.toString(),
                                              remarks: 'Stories unlockced',
                                            ),
                                          );
                                          dsc.saveProfile(
                                            ProfileModel(
                                              ...
                                              premiumUser: 1,
                                              username: dsc.profile!.username,
                                              password: dsc.profile!.password,
                                              email: dsc.profile!.email,
                                              phone: dsc.profile!.phone,
                                              notificationId:
                                                  dsc.profile!.notificationId,
                                              profileImage:
                                                  dsc.profile!.profileImage,
                                            ),
                                          );
                                          dsc.readProfile();
                                          Navigator.push(
                                  ...
                                  subtitle: dsc.profile!.premiumUser == 0
                                      ? Text(
                                          "Pay to access",
                                          style: TextStyle(
                                      ...
                                      : null,
                                  trailing: dsc.profile!.premiumUser == 0
                                      ? Icon(
                                          Icons.lock_outlined,
                                          color: Colors.blue[300],
                                        )
