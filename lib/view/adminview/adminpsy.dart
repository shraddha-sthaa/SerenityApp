...
import 'package:serenity/controller/psyreadingcontroller.dart';
...
class AdminPsyView extends StatelessWidget {
  const AdminPsyView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: GetBuilder<PsyReadingController>(
          init: PsyReadingController(),
          builder: (controller) {
            return Stack(
              children: [
                ImageFiltered(
  ...
  Card userDetailsCard(String username, String email, DateTime date) {
    return Card(
      color: Colors.blueGrey[800],
      child: Padding(
