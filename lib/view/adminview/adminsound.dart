...
import 'package:serenity/controller/uploadsoundcontroller.dart';
...
class SoundUploadView extends StatefulWidget {
  SoundUploadView({Key? key}) : super(key: key);
...
class _SoundUploadViewState extends State<SoundUploadView> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<UploadSoundController>(
        init: UploadSoundController(),
        builder: (controller) {
          return Form(
            key: formKey,
            child: Scaffold(
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (formKey.currentState!.validate()) {
                                controller.uploadSound(
                                    SoundModel(
                                        soundId: 0,
                                        soundImage: "",
                                        audio: '',
                                        soundType: categoryController.text,
                                        soundName: titleController.text,
                                        description: descriptionController.text,
                                        soundDate: DateTime.now().toString()),
                                    pickedImage,
                                    pickedAudio,
                                    context);
                                ...
                                RemoteServices.sendNotification(
                                  ...
                                  body:
                                      "Listen to our newly added meditation guide",
                                );
                              }
                            },
                            child: const Padding(
