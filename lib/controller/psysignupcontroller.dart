...
class PsySignupController extends GetxController {
  bool loading = false;

  void signUp(PsyProfileModel model, BuildContext context,
      {bool socialAuth = false}) async {
    loading = true;
    update();
    var response = await RemoteServices.psySignUp(model);
